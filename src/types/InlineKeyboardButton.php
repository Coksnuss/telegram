...
class InlineKeyboardButton implements \JsonSerializable
{
    ...
    /**
     * @var CallbackGame Optional. Description of the game that will be launched when the user presses the button.NOTE: This type of button must always be the first button in the first row.
     */
    public $callbackGame;

    /**
     * @var bool Optional. Specify True, to send a Pay button.NOTE: This type of button must always be the first button in the first row.
     */
    public $pay;
}
